...
from lzero.mcts.ctree.ctree_rezero import mz_tree as tree_muzero
...
if TYPE_CHECKING:
    ...
    from lzero.mcts.ctree.ctree_rezero import mz_tree as mz_ctree
...
class MuZeroMCTSCtree(object):
    ...
    def roots(cls: int, active_collect_env_num: int, legal_actions: List[Any]) -> "mz_ctree":
        ...
        """
        from lzero.mcts.ctree.ctree_rezero import mz_tree as ctree
